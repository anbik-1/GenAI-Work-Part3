...
class GeneseProposalAIStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs):
        ...
        CfnOutput(self, "ApiRepoUri", value=f"654654306837.dkr.ecr.{self.region}.amazonaws.com/genese-proposal-ai-api", description="ECR repo for API image")
        CfnOutput(self, "WorkerRepoUri", value=f"654654306837.dkr.ecr.{self.region}.amazonaws.com/genese-proposal-ai-worker", description="ECR repo for Worker image")
